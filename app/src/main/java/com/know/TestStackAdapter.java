...
//        }
    ...
    static class ColorItemViewHolder extends CardStackView.ViewHolder {
        ...
        TextView mTextTitle,mTextMassage;
        String[] title,text;
        public ColorItemViewHolder(View view) {
            ...
            mTextMassage = (TextView) view.findViewById(R.id.text_view);
        ...
        public void onItemExpand(boolean b) {
            ...
            title=getContext().getResources().getStringArray(R.array.know_title);
            text=getContext().getResources().getStringArray(R.array.know_massage);
        }
        //此处添加数据,position的小标从0开始
        public void onBind(Integer data, int position) {
            mLayout.getBackground().setColorFilter(ContextCompat.getColor(getContext(), data), PorterDuff.Mode.SRC_IN);
            mTextTitle.setText(title[position]);
            mTextMassage.setText(text[position]);
        }
